...
import com.uni.project.pricelookup.ML.ColorFilter.Companion.compareColorList
import com.uni.project.pricelookup.ML.ColorFilter.Companion.getImageColors
import java.io.File
...
class OCR()  {
    ...
    private fun ProcessResult(
        ...
        //2. if they match 60% of color of the block belongs price tag
